...
class ProductDashboard {
                ...
                <div class="product-card" data-id="${product.id}" style="animation-delay: ${product.animationDelay}s">
                    ...
                    <div class="product-image-wrapper">
                        <img 
                            ...
                            alt="${product.title}"
                            loading="lazy"
                            onerror="this.onerror=null; this.src='https://via.placeholder.com/200x200?text=🖼️'"
                        >
                    </div>
    ...
    showError(message) {
        ...
        document.querySelector('.products-section .container').insertAdjacentHTML('afterbegin', alertHTML);
    }
